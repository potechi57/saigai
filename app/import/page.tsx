...
//   1. 防災カルテ点検（自然災害・斜面災害リスクの点検）：落石・崩壊、盛土、擁壁、
//      橋梁基礎の洗掘、地吹雪等を対象とする、防災カルテ様式特有のExcel（様式Ａ〜Ｄ）。
//      防災カルテExcelの取込・手入力がこちらに該当する（岩盤崩壊・地すべり・雪崩・
//      土石流は、島根県での運用実態に合わせKarteType自体から除いた。
//      prisma/schema.prismaのKarteTypeコメント参照）。
//   2. 施設一覧・台帳：法面構造物、道路標識等の道路附属物、橋梁、トンネル等、道路施設
//      全般の管理データ。「施設一覧」形式のExcelは、法面・道路標識・橋梁等どの施設種別
...
const GROUPS: {
...
}[] = [
  {
    title: "防災カルテ点検",
    scope:
      "自然災害・斜面災害のリスクを対象とする点検です。落石・崩壊、盛土、擁壁、橋梁基礎の洗掘、地吹雪等が対象です。",
    methods: [
      {
        title: "防災カルテExcelの取込",
        description:
    ...
    <div className="mx-auto max-w-3xl space-y-6 p-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          道路標識・橋梁・トンネル等、道路施設全般）の2系統に分かれます。盛土・擁壁のように
