...
//
// 点検・台帳の対象は、国土交通省道路局「道路土工構造物点検要領」（令和５年３月）の
// 整理に沿って、大きく2系統に分かれる（下記GROUPS参照）。
//   - 自然斜面（道路区域外）：落石・崩壊、地すべり、雪崩、土石流等の自然現象を対象と
//     する「防災カルテ点検」。防災カルテExcelの取込・手入力がこちらに該当する。
//   - 道路土工構造物等（道路区域内）：切土・盛土等の法面構造物、大型カルバート・
//     シェッド、橋梁、ブロック積等の構造物を対象とする点検・台帳管理。施設一覧Excelの
//     取込・台帳（画像）の登録がこちらに該当する。
...
const GROUPS: {
  ...
  {
    title: "道路土工構造物等の点検・台帳",
    scope:
      "道路区域内の法面構造物（切土・盛土等）、大型カルバート・シェッド、橋梁、ブロック積等が対象です。",
    methods: [
      {
        icon: "🛣️",
        title: "施設一覧Excelの取込",
    ...
    <div className="mx-auto max-w-3xl space-y-6 p-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          「自然斜面の点検（防災カルテ点検）」と「道路土工構造物等の点検・台帳」の2系統に分かれます
          （国土交通省道路局「道路土工構造物点検要領」参照）。
        </p>
      </div>
